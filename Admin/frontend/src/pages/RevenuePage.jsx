                ...
                <div className="stat-card premium-shadow" style={{ borderLeft: '4px solid var(--success)' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                        <div>
                            ...
                            <h2 style={{ fontSize: '36px', marginTop: '12px', fontWeight: '800', color: 'var(--success)' }}>${totalRevenue.toLocaleString()}</h2>
                        </div>
                ...
                <div className="stat-card premium-shadow" style={{ borderLeft: '4px solid var(--primary)' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                        <div>
                            ...
                            <h2 style={{ fontSize: '36px', marginTop: '12px', fontWeight: '800', color: 'var(--primary)' }}>${totalCommissions.toLocaleString()}</h2>
                        </div>
                        ...
                        <tbody>
                            {stats.map(item => (
                                <tr key={item.id}>
                                    ...
                                    <td style={{ color: 'var(--primary)', fontWeight: '700' }}>+ ${item.commission.toLocaleString()}</td>
                                    <td>
