...
const categoryToType = (category = "") => {
  ...
  if (normalized.includes("conference") || normalized.includes("workshop") || normalized.includes("theatre") || normalized.includes("play")) {
    return "play";
  }
...
export default function Events() {
            ...
            {rows.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {item.source === "created" && (
                    <p className="events-card__city">Created Event</p>
                  )}
  ...
  return (
    <div className="events-page">
      ...
      {(selectedType === 'all' || ['music', 'comedy', 'play', 'sports'].includes(selectedType)) && renderRow("Live Events", "Concerts, comedy and tech gatherings", mergedLiveEvents)}
      {(selectedType === 'all' || ['music', 'comedy', 'play', 'sports'].includes(selectedType)) && renderRow("Upcoming Events", "Plan your next outing ahead", mergedUpcomingEvents)}
    </div>
  );
}
