...
export default function Success() {
  ...
  const walletCredit = Number(state?.walletRewardCredit || 0);
          ...
          <div className="success-layout">
              ...
              <div className="success-ticket__meta-grid">
                ...
                {walletCredit > 0 && (
                  <div className="success-meta-box">
                    ...
                    <strong>Rs. {walletCredit.toLocaleString("en-IN")}</strong>
                  </div>
                )}
                <div className="success-meta-box">
                  <span>Booked On</span>
            ...
            <aside className="success-info" aria-label="Next steps">
              ...
              <ul className="success-steps">
                ...
                {walletCredit > 0 && <li>Rs. {walletCredit.toLocaleString("en-IN")} has been added to your wallet from this offer.</li>}
